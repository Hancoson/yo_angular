		...
		ngupdate: {
			options: {
				...
				append: [
					{
						selector: 'body',
						html    : '<script src="ngapp/ngapp-lib.min.js" ></script>' +
						'<script src="ngapp/ngapp.min.js" ></script>'
		...
		spapp   : {
			options: {
				...
				append: [
					{
						selector: 'body',
						html    : '<script src="spApp/spapp-lib.min.js" ></script>' +
						'<script src="spApp/spapp.min.js" ></script>'
					}
					//{
					//	selector: 'head',
					//	html    : '<link rel="stylesheet" href="src/styles/common.min.css" type="text/css"/>'
